# -*- coding: utf-8 -*-
from hantext.hantext_model import hantext
from hantext.hantext_config import FLAGS
from utils.load_data_helper import load_pickle_data, load_meta_data,load_word_embeddings, load_label_embeddings, drop_word
...
def main(_):
    ...
    with open(os.path.join(FLAGS.log_dir,FLAGS.data_name + '-results.csv'), 'wt') as fout:
        keys = result.keys()
